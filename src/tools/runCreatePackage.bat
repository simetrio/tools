...
set name1=template
set name2=Template
set demo=template-demo
set desc="Template description"
...
PublishTools.exe -mode ReplaceInAllFiles --name %to% --from "template-demo-page" --to %demo%
PublishTools.exe -mode ReplaceInAllFiles --name %to% --from "template-desc" --to %desc%
