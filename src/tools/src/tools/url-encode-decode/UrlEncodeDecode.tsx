        ...
        <>
            ...
            <MDBRow>
                <MDBCol md="6" className="mb-3">
                    <MDBInput label="Decoded Url" textarea rows={10} value={formValue.decoded} onChange={onEncode} />
                </MDBCol>

                <MDBCol md="6" className="mb-3">
                    <MDBInput label="Encoded Url" textarea rows={10} value={formValue.encoded} onChange={onDecode} />
                </MDBCol>
            </MDBRow>
        </>
    );
